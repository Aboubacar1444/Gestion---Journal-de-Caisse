	...
	<div class="container">
 		...
 		<div class="row">
          ...
          echo"<tbody>";
            ...
            $s2=0;
            $solde=0;
              $req=$connexion->query("SELECT DISTINCT depense.ref,depense.datee,depense.mtchiffre,depense.libelleop from relation inner join depense on depense.ref=relation.refdepense  where datee BETWEEN'2018-03-01' AND '2018-03-31'");
              $req1=$connexion->query("SELECT DISTINCT recette.ref_r,recette.datee_r,recette.mtchiffre_r,recette.libelleop_r from relationr inner join recette on recette.ref_r=relationr.refrecette Where datee_r BETWEEN'2018-03-01' AND '2018-03-31'");

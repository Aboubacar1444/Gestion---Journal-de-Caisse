		...
		<div class="row">
			<div class="flex col-lg-6">
				<form action="" method="post" class="form-control form-group ">
					...
					<input type="text" name="date"  required class="form-control" placeholder="Date : <?php echo $date; ?>" maxlength="10" autofocus value="<?=$date ?>"><br>
					...
					<textarea name="mtlettre" id='lettres' cols="30" rows="3" required placeholder="Arrêtée la présente pièce de caisse de dépense à la somme de : <?php echo $mtlettre; ?>" class="form-control" readonly><?=$mtlettre ?>&nbsp</textarea><hr>
					
					<div class="col-lg-12  flex">
						<div class="col-lg-3 d-inline flex">Accord direction <br>
							<input type="checkbox" name="direction" value="<?=$direction ?>" class="form-control flex">
						</div>
						<div class="col-lg-5  d-inline 	flex">Caissier(e)<br>
							<input type="checkbox" name="caisse" class="form-control" value="<?=$caisse ?>">
						</div>
						<div class="col-lg-5  d-inline 	flex">Le bénéficiaire
							<input type="checkbox" name="benef" placeholder="bénéficiaire" class="form-control flex" value="<?=$benef ?>">
						</div>
					</div>
					<hr>
